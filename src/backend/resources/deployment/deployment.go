...
func GetDeploymentList(indexer *client.CacheFactory, namespace string) ([]*v1.Deployment, error) {
...
func GetDeploymentResource(cli client.ResourceHandler, deployment *v1.Deployment) (*common.ResourceList, error) {
...
func CreateOrUpdateDeployment(cli *kubernetes.Clientset, deployment *v1.Deployment) (*v1.Deployment, error) {
...
func UpdateDeployment(cli *kubernetes.Clientset, deployment *v1.Deployment) (*v1.Deployment, error) {
	old, err := cli.AppsV1().Deployments(deployment.Namespace).Get(deployment.Name, metaV1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func checkDeploymentLabelSelector(new *v1.Deployment, old *v1.Deployment) error {
...
func GetDeployment(cli *kubernetes.Clientset, name, namespace string) (*v1.Deployment, error) {
...
func toDeployment(deployment *v1.Deployment, indexer *client.CacheFactory) (*Deployment, error) {
	result := &Deployment{
...
func DeleteDeployment(cli *kubernetes.Clientset, name, namespace string) error {
	...
	return cli.AppsV1().Deployments(namespace).Delete(name, &metaV1.DeleteOptions{PropagationPolicy: &deletionPropagation})
}
