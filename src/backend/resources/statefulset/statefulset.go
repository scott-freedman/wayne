...
func GetStatefulsetResource(cli client.ResourceHandler, statefulSet *v1.StatefulSet) (*common.ResourceList, error) {
...
func CreateOrUpdateStatefulset(cli *kubernetes.Clientset, statefulSet *v1.StatefulSet) (*v1.StatefulSet, error) {
