...
func (c *KubeStatefulsetController) Create() {
	...
	var kubeStatefulset v1.StatefulSet
...
func checkResourceAvailable(ns *models.Namespace, cli client.ResourceHandler, kubeStatefulset *v1.StatefulSet, cluster string) error {
